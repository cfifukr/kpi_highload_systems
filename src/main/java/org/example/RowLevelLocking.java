...
public class RowLevelLocking {
    ...
    private static void rowLevelLocking() throws InterruptedException {
        String selectUserCounter = "SELECT counter FROM user_counter WHERE userId = 1 FOR UPDATE";
